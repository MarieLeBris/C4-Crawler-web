...
description:
management of the 2 states of switch ligts
...
************************************************************************************************** */
function on_off(id){
    on_off = document.getElementById(id).value;
    document.getElementById("on").classList.remove('truc');
    document.getElementById("off").classList.remove('truc');
    document.getElementById(id).classList.add('truc');
